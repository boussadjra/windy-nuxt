...
<section>
    ...
    <div class="space-y-2">
        ...
        <div class="w-full grid--auto-cols gap-4">
            <card>
                <template #media>
                    <img :src="$router.options.base+'img/salade.jpg'" alt="" />
                </template>
                <p class="text-gray-600 dark:text-white    text-sm">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus
                    illum totam nulla, sunt enim numquam eveniet animi nostrum eius quia
            ...
            <card>
                ...
                <template #media>
                    <img :src="$router.options.base+'img/walter-verna.jpg'" alt="" />
                </template>
                <p class="text-gray-600 dark:text-white    text-sm">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus
                    illum totam nulla, sunt enim numquam eveniet animi nostrum eius quia
            ...
            <card>
                <template #media>
                    <img :src="$router.options.base+'img/aflou.jpg'" alt="" />
                </template>
                <div>
    ...
    <div class="space-y-2">
        ...
        <div class="w-full grid  gap-4 place-items-start">
            <card>
                <template #mediaAside>
                    <div class="w-96">
                        <img :src="$router.options.base+'img/scott-webb.jpg'" alt="" />
                    </div>
                </template>
                <div class="h-full ">
