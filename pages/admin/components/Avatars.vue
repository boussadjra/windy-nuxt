    ...
    <div class="space-y-2 pb-4">
        ...
        <div class="w-full grid--auto-cols gap-4 lg:gap-x-16">
            <card class="min-w-max">
                <template #media>
                    <img :src="$router.options.base+'img/walter-verna.jpg'" class="h-48 w-96" />
                </template>
                <div class="relative flex flex-col items-center w-full">
                    <avatar :src="githubUser.avatar_url" shape="rounded-full" size="md" class="absolute -top-16 flex bg-purple-200 text-purple-100 row-start-1 row-end-3 text-purple-650 ring-1 ring-white">
                    </avatar>
            ...
            <card class="min-w-max">
                <template #media>
                    <img :src="$router.options.base+'img/masonry.jpg'" class="h-48 w-96" />
                </template>
                <div class="relative flex flex-col items-center w-full">
                    <avatar :src="SOFUser.profile_image" shape="rounded-full" size="md" class="absolute -top-16 flex bg-purple-200 text-purple-100 row-start-1 row-end-3 text-purple-650 ring-1 ring-white">
                    </avatar>
                    <div class="flex flex-col space-y-1 items-center -mt-12 w-full">
                        ...
                        <span class="flex space-x-2 py-3 items-center">
                            <span class="text-4xl text-purple-600 font-bold">{{
                SOFUser.reputation
              }}</span>
                  ...
                  ">
                        ...
                        <div class="py-4 flex justify-center items-center w-full divide-x divide-gray-400 divide-solid">
                            <span class="text-center px-2"><span class="font-bold text-gray-700">{{
                  SOFUser.answer_count
                }}</span><span class="text-gray-600"> answers</span></span>
                            <span class="text-center px-2"><span class="font-bold text-gray-700">{{
                  SOFUser.question_count
                }}</span><span class="text-gray-600"> questions</span></span>
                        </div>
                    </div>
                </div>
            </card>
